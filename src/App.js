    ...
    <div className="note-app">
        ...
        <div className="flex justify-between content-center items-center">
          <Link to="/archives" className="mr-4 pb-2 animate-scale drop-shadow-sm"><RiArchiveFill size={36} className="text-white hover:text-slate-200" /></Link>
          {
            (
              path === pathHome
              || path === pathArchive
              || path.substring(0, 10) === '/?keyword='
              || path.substring(9, 10) === '/?keyword=')
      ...
      <main>
        <Routes>
          ...
          />
          {/* <Route path="/notes/new" element={<AddPage onUpdate={onUpdateHandler} />} />
          <Route path="/notes/:id" element={<DetailPage onUpdate={onUpdateHandler} />} /> */}
...
//           <Link to="/" className="flex justify-start">
//             <img
// className="flex-none w-12 h-12 rounded-lg animate-scale"
// src="/images/logo.png"
// alt="NoteApp Logo" />
//             <h1
// className="hidden md:block flex-initial px-3 text-4xl text text-sky-100 hover:drop-shadow-2xl">
//               Rubie&apos;s NotesApp
//             </h1>
//           </Link>
//           <div className="flex justify-between content-center items-center">
//             <Link
// to="/archives"
// className="mr-4 pb-2 animate-scale drop-shadow-sm">
// <RiArchiveFill size={36} className="text-white hover:text-slate-200" />
// </Link>
//             { (path === '/'
//               || path === '/archives'
